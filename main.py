...
<style>
html, body { margin: 0; padding: 0; width: 820px; background: #10182f; font-family: "Microsoft YaHei", "PingFang SC", sans-serif; }
.klbq-card { width: 820px; box-sizing: border-box; position: relative; overflow: hidden; padding: 34px; color: #edf7ff; background: linear-gradient(135deg, #10182f 0%, #182a55 48%, #5d3ca0 100%); }
    ...
    async def _render_image(self, title: str, kind: str, items: list[dict[str, str]], thumb: str, tip: str) -> Optional[str]:
        try:
            ...
            return await self.html_render(
                ...
                options={"type": "png", "full_page": False, "omit_background": False},
            )
        except Exception as e:
